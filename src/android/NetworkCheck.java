...
public class NetworkCheck extends CordovaPlugin {
    ...
    public static final String ACTION_INIT_REACH = "getCurrentNetAvailableWithHostName";
        ...
        if (this.receiver == null) {
            this.receiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (NetworkCheck.this.webView != null) {
                        updateConnectionInfo(sockMan.getActiveNetworkInfo());
                    }

                    String connectionType = null;
                    if (NetworkCheck.this.lastInfo == null) {
                        connectionType = TYPE_NONE;
                    } else {
                        try {
                            connectionType = NetworkCheck.this.lastInfo.get("type").toString();
                        } catch (JSONException e) {
                            LOG.d(LOG_TAG, e.getLocalizedMessage());
                            connectionType = TYPE_NONE;
                        }
    ...
    public boolean getCurrentNetAvailableWithHostName(String hostName) {
